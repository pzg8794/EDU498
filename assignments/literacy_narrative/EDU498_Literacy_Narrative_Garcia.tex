...
In my classroom, this understanding will shape what I design, what I assess, and what I treat as evidence of learning. For neurodivergent students, CLD students, and students navigating multiple intersecting identities, literacy instruction needs to open multiple pathways rather than narrow them. Concretely, that means building lessons where students can demonstrate understanding through code, speech, design, or peer explanation---not only through written paragraphs. It means treating a student's home language as a cognitive resource, not an interference. And it means teaching students to read systems critically: to ask who a technology was built for, whose data it uses, and who benefits from the decisions it makes. This is the kind of literacy instruction that honors the full complexity of the students I will teach---and the full complexity of the literacy journeys, including my own and my father's, that brought us all into the room.

\section*{References}

Gee, J. P. (1989). Literacy, discourse, and linguistics: Introduction. \textit{Journal of Education, 171}(1), 5--17.

New London Group. (1996). A pedagogy of multiliteracies: Designing social futures. \textit{Harvard Educational Review, 66}(1), 60--92.

Street, B. V. (1984). \textit{Literacy in theory and practice}. Cambridge University Press.
